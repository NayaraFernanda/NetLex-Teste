...
function wordSentences() {
    ...
    console.log("Teste 1 "+DocumentHelper.wordSentences(doc, 'setembro'));
    console.log("Teste 2 "+DocumentHelper.wordSentences(doc, 'vigência'));
    console.log("Teste 3 "+DocumentHelper.wordSentences(doc, 'mediante'));
